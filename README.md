...
It is the information that the browser reads in order to create the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

block elements can only have one on each line. Inline puts certain elements on the same line.
...
it's a faster way to save a project.
